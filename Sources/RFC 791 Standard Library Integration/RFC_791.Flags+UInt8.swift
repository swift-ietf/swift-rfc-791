...
// RFC_791.Flags+UInt8.swift
//
// Stdlib-interop UInt8 forwarder for IP Flags. Primary byte-domain API
// lives in `RFC 791`; this forwarder bridges stdlib callers carrying
